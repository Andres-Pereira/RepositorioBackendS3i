    ...
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            ...
            CreateMap<Venta, VentaDTO>()
                 ...
                 .ForMember(destino =>
                    destino.EsPagado,
                    opt => opt.MapFrom(origen => origen.EsPagado == true ? 1 : 0)
                )
                 .ForMember(destino =>
            ...
            CreateMap<VentaDTO, Venta>()
                ...
                .ForMember(destino =>
                   destino.EsPagado,
                   opt => opt.MapFrom(origen => origen.EsPagado == 1 ? true : false)
                )
                .ForMember(destino =>
                    destino.FechaRegistro,
                    opt => opt.Ignore()
            ...
            CreateMap<Activo, ActivoDTO>()
                ...
                .ForMember(destino =>
                    destino.EsContrato,
                    opt => opt.MapFrom(origen => origen.EsContrato == true ? 1 : 0)
                )
                .ForMember(destino =>
                    destino.FechaCaducidad,
                    opt => opt.MapFrom(origen => origen.FechaCaducidad.Value.ToString("yyyy-MM-dd"))
                );
            ...
            CreateMap<ActivoDTO, Activo>()
                ...
                .ForMember(destino =>
                    destino.EsContrato,
                    opt => opt.MapFrom(origen => origen.EsContrato == 1 ? true : false)
                )
                .ForMember(destino =>
                    destino.FechaCaducidad,
                    opt => opt.MapFrom(origen => DateTime.ParseExact(origen.FechaCaducidad, "yyyy-MM-dd", new CultureInfo("es-BO")))
                    );
